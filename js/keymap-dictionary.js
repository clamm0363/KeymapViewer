...
export const KeymapDictionary = {
  ...
  keys: {
    ...
    "KC_RGB_M_P": { text: "RGB M P" },
    "KC_RGB_M_B": { text: "RGB M B" },
    "KC_RGB_M_R": { text: "RGB M R" },
    "KC_RGB_M_SW": { text: "RGB M SW" },
    "KC_RGB_M_SN": { text: "RGB M SN" },
    "KC_RGB_M_K": { text: "RGB M K" },
    "KC_RGB_M_X": { text: "RGB M X" },
    "KC_RGB_M_G": { text: "RGB M G" },
    "KC_RGB_M_T": { text: "RGB M T" },
    "KC_RGB_M_TW": { text: "RGB M TW" },
    "KC_BL_ON": { text: "BL ON" },

...
export function LinksModal({ isLightApp, onClose }) {
  ...
  return createElement(
    'div',
    {
      key: 'links-modal',
      className:
        'fixed inset-0 z-[100] flex items-start justify-center bg-black/50 backdrop-blur-sm pt-28 md:pt-32 overflow-y-auto',
      onClick: onClose,
    },
    [
      createElement(
        'div',
        {
          key: 'links-content',
          className:
            (isLightApp ? 'bg-white border-slate-200' : 'bg-slate-900 border-slate-700') +
            ' border rounded-2xl shadow-2xl max-w-md w-full mx-4 overflow-hidden animate-in fade-in slide-in-from-top-4 duration-200',
        ...
        [
          ...
          createElement(
            'div',
            {
              key: 'links-header',
              className:
                (isLightApp ? 'bg-slate-50 border-slate-200' : 'bg-slate-900 border-slate-800') +
                ' border-b px-6 py-4 flex justify-between items-center z-10',
            },
            [
              createElement(
                'h3',
              ...
              createElement(
                'button',
                {
                  ...
                  onClick: onClose,
                  className:
                    'text-slate-500 hover:text-red-500 transition-colors text-xl font-bold p-1 leading-none',
                  title: '閉じる',
                },
                '✕'
              ),
                    ...
                    createElement(
                      'div',
                      {
                        ...
                        className:
                          ...
                          ' w-10 h-10 rounded-xl flex items-center justify-center border shadow-sm p-1.5 shrink-0 group-hover:scale-105 transition-transform duration-200',
                      },
                      [
                        createElement('img', {
                          key: 'favicon-img',
                    ...
                    createElement('div', { key: 'text-grp', className: 'flex-1 min-w-0' }, [
                      createElement(
                        'div',
                        {
                          key: 'name',
                          className:
                            'font-black text-xs uppercase tracking-wider text-blue-500 flex items-center gap-1.5',
                        },
                        [
                          link.name,
                          createElement(
                            'svg',
                            {
                              ...
                              strokeWidth: 2.5,
                              className:
                                'opacity-0 group-hover:opacity-100 transition-opacity duration-200 transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5',
                            },
                            [
                              createElement('path', {

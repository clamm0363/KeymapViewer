      ...
      createElement(
        'div',
        {
          ...
          className:
            ...
            ' border rounded-2xl shadow-2xl max-w-md w-full mx-4 p-6',
          onClick: (e) => e.stopPropagation(),
        },
        [
          createElement(
            'h3',
            { key: 'h3', className: 'text-lg font-black uppercase tracking-wide mb-6' },
            'Export Image'
          ),
          createElement('div', { key: 'export-body', className: 'space-y-6' }, [
            createElement(
              'button',
              {
                ...
                className:
                  'w-full py-3 bg-blue-600 text-white rounded-xl font-black uppercase tracking-widest hover:bg-blue-500 transition-all',
              },

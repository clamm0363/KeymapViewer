    ...
    [
      createElement(
        'div',
        {
          ...
          className:
            panelClass + ' mx-4 flex w-full max-w-lg flex-col rounded-2xl border shadow-2xl',
        ...
        [
            ...
            [
              ...
              createElement(
                'button',
                {
                  ...
                  className:
                    'text-xl font-bold text-slate-500 transition-colors hover:text-blue-500 disabled:cursor-not-allowed disabled:opacity-40',
                },
                '✕'
              ),
            ]
          ...
          createElement('div', { key: 'body', className: 'flex flex-col gap-4 px-6 py-6' }, [
            step === 'root'
              ? createElement(React.Fragment, { key: 'root-options' }, [
                  createElement(
                    'button',
                    {
                      key: 'file-option',
                      ...
                      disabled: isBusy,
                      className:
                        secondaryButtonClass + ' disabled:cursor-not-allowed disabled:opacity-50',
                    },
                    [
                      createElement(
                        'div',
                  ...
                  createElement(
                    'button',
                    {
                      ...
                      disabled: isBusy,
                      className:
                        primaryButtonClass + ' disabled:cursor-not-allowed disabled:opacity-60',
                    },
                    [
                      createElement(
                        'div',
                        {
                          key: 'device-label',
                          className:
                            'text-[11px] font-black uppercase tracking-[0.2em] text-blue-100',
                        },
                        'WebHID'
                      ),
                      createElement(
              ...
              : null,
            step === 'post-layout'
              ? createElement(React.Fragment, { key: 'post-layout-options' }, [
                  createElement(
                    'div',
                    {
              ...
              : null,
            step === 'device'
              ? createElement(React.Fragment, { key: 'device-options' }, [
                  createElement(
                    'div',
                    {
                      key: 'device-note',

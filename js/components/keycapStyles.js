...
export const getBottomCaptionStyle = (isLight, color = null) => ({
  fontSize: '15px',
  fontWeight: '500',
  color: color || (isLight ? '#64748b' : '#bfd0e6'),
  opacity: color ? (isLight ? 0.98 : 0.98) : 0.9,
  fontFamily: '"Outfit", "Arial", "Helvetica", sans-serif',
...
export const getOffsetSecondaryContentStyle = (isLight, color, customFontSize = '10px') => ({
  ...
  fontWeight: '500',
  fontFamily: '"Outfit", "Arial", "Helvetica", sans-serif',
  color: color || (isLight ? '#64748b' : '#c4d3e6'),
  opacity: color ? (isLight ? 0.99 : 0.98) : 0.9,
  lineHeight: '1',
  textAlign: 'right',
  textTransform: 'uppercase',
  display: 'inline-block',

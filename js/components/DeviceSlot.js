    ...
    if (Array.isArray(opts)) {
      choices = opts.map((c, cIdx) => {
        if (typeof c === 'string') {
          ...
          return {
            value: c.value !== undefined ? c.value : cIdx,
...
export function DeviceSlot({
  ...
  const settingsPanel = createElement(
    ...
    [
      createElement(
        'div',
        { key: 'global-opts', className: 'flex flex-wrap items-stretch gap-4' },
        [
          createElement(
            'div',
            {
              ...
              className:
                ...
                ' p-2 px-4 rounded-xl border ' +
                (isLightApp ? 'border-slate-200' : 'border-slate-800/50'),
            },
            [
              createElement(
                'span',
          ...
          createElement(
            'div',
            {
              key: 'scale-sect',
              className:
                'flex min-w-0 w-full flex-wrap items-center gap-3 ' +
                (isLightApp ? 'bg-white' : 'bg-slate-950/30') +
                ' p-2 px-4 rounded-xl border ' +
                (isLightApp ? 'border-slate-200' : 'border-slate-800/50'),
            },
            [
              ...
              createElement('input', {
                ...
                className:
                  'min-w-[180px] flex-1 accent-blue-500 ' +
                  (isScaleFollowing ? 'opacity-40 cursor-not-allowed' : ''),
              }),
              createElement(
                'span',
                {
                  key: 'value',
                  className:
                    'w-12 text-right text-[10px] font-black ' +
                    (isScaleFollowing
                      ? 'text-slate-400'
                      : isLightApp
                        ? 'text-slate-700'
              ...
              createElement(
                'button',
                {
                  ...
                  className:
                    ...
                    (isScaleFollowing ? 'cursor-not-allowed' : ''),
                },
                '100%'
              ),
              createElement(
      ...
      hasDeviceSpecificOptions
        ? createElement(
            'div',
            { key: 'device-opts', className: 'flex flex-wrap items-stretch gap-4' },
            [
              showSeparation
                ? createElement(
                    'div',
                ...
                return createElement(
                  'div',
                  {
                    ...
                    className:
                      ...
                      (isLightApp ? 'bg-white' : 'bg-slate-950/30') +
                      ' p-2 px-4 rounded-xl border md:flex-row md:items-center md:gap-4 ' +
                      (isLightApp ? 'border-slate-200' : 'border-slate-800/50'),
                  },
                  [
                    createElement(
  ...
  useEffect(() => {
    const nextPage = Math.min(
      totalLayerPages - 1,
      Math.floor((Number(dev.layer) || 0) / MAX_VISIBLE_LAYER_BUTTONS)
    );
      ...
      ? createElement(
          ...
          [
            createElement(
              ...
              {
                key: 'lbl',
                className: 'px-1 text-[9px] font-black uppercase tracking-[0.22em] text-slate-400',
              },
              'LAYER'
            ),
            showLayerPagination
              ? createElement(
                  'button',
                  {
                    ...
                    className:
                      (clampedLayerPage === 0 ? 'cursor-not-allowed opacity-35 ' : '') +
            ...
            createElement(
              'div',
              { key: 'btns', className: 'flex gap-1.5' },
            ...
            showLayerPagination
              ? createElement(
                  'button',
                  {
                    ...
                    className:
                      (clampedLayerPage >= totalLayerPages - 1
  ...
  return createElement(
    ...
    [
      createElement(
        ...
        createElement(
          'div',
          {
            ...
            title: 'Drag Slot',
            className:
              'pointer-events-auto flex h-9 min-w-[132px] cursor-grab active:cursor-grabbing items-center justify-center gap-3 rounded-full border px-4 shadow-lg backdrop-blur-sm transition-colors ' +
              (isLightApp
      ...
      createElement('div', { key: 'slot-header', className: 'mb-5 flex flex-col gap-3' }, [
        createElement(
          'div',
          { key: 'header-main-row', className: 'flex min-w-0 items-center justify-between gap-3' },
          [
            createElement(
              'div',
              { key: 'title-grp', className: 'flex min-w-0 flex-1 items-center gap-3' },
              [
                createElement(
                  'span',
                  {
                    key: 'slot-idx',
                    className:
                      'inline-flex h-5 flex-shrink-0 items-center justify-center whitespace-nowrap rounded-md bg-blue-600 px-2 text-[10px] font-black uppercase tracking-wider text-white pt-[1px]',
                  },
                  'Slot ' + (idx + 1)
                ),
                editingDeviceId === dev.id
                  ...
                  : createElement(Fragment, { key: 'name-static' }, [
                      createElement(
                        'div',
                        { key: 'title-stack', className: 'flex min-w-0 flex-1 items-center gap-2' },
                        [
                          createElement(
                            'h2',
                            {
                              key: 'h2',
                              className:
                                'min-w-0 break-words text-lg font-black leading-tight tracking-tight uppercase ' +
                                (isLightApp ? 'text-slate-900' : 'text-slate-100'),
                          ...
                          createElement(
                            ...
                            {
                              key: 'edit-btn',
                              onClick: () => onStartEditing(dev),
                              className:
                                'flex-shrink-0 p-1 text-slate-400 hover:text-blue-400 transition-colors',
                            },
            ...
            createElement(
              'div',
              { key: 'header-controls', className: 'flex flex-shrink-0 items-center gap-1' },
              [
                createElement(
                  'button',
                  {
                ...
                createElement(
                  ...
                  {
                    key: 'settings-btn',
                    onClick: () => onUpdateDevice(dev.id, { showSettings: !dev.showSettings }),
                    className:
                      'p-2 ' +
                      (dev.showSettings
          ...
          isGridLayout
                ...
                createElement(
                  ...
                  [
                    ...
                    createElement(
                      ...
                      {
                        key: 'macro-btn',
                        onClick: () => onSetMacroModal({ deviceId: dev.id, macroId: null }),
                        className: neutralActionButtonClass,
                      },
                      'MACROS'
                    ),
            ...
            : [
                ...
                createElement(
                  ...
                  {
                    key: 'action-band',
                    className: 'flex flex-wrap items-center gap-2 lg:ml-auto lg:justify-end',
                  },
                  [
                    createElement(
                      'button',
      ...
      dev.design
              ...
              dev.showSettings && !isGridLayout
                ? createElement(
                    'aside',
                    {
                      key: 'settings-drawer',
                      className:
                        'order-1 flex w-full min-w-0 flex-col gap-4 overflow-y-auto overflow-x-hidden rounded-2xl border p-4 shadow-2xl ring-1 animate-in fade-in slide-in-from-right-2 lg:order-2 lg:sticky lg:top-6 lg:max-h-[70vh] lg:min-w-[30rem] ' +
                        (isLightApp
                          ? 'bg-white border-slate-200 ring-slate-200/80'
                          : 'bg-slate-950 border-slate-700 ring-slate-700/80'),
              ...
              dev.showSettings && isGridLayout
                ? createElement(
                    'div',
                    {
                      ...
                      className:
                        'order-3 flex w-full min-w-0 flex-col gap-4 overflow-x-hidden rounded-2xl border p-4 shadow-2xl ring-1 animate-in fade-in slide-in-from-top-2 ' +
                        (isLightApp
                          ? 'bg-white border-slate-200 ring-slate-200/80'
                          : 'bg-slate-950 border-slate-700 ring-slate-700/80'),
                    },
        ...
        : createElement('div', { key: 'empty-area', className: 'py-20 text-center opacity-20' }, [
            ...
            createElement(
              'p',
              { key: 'text', className: 'text-[10px] font-black uppercase tracking-widest' },
              'Waiting for Data'
            ),
          ]),
      annotatingKey !== null &&

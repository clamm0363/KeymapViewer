...
export function renderStandardKeycap({ k, model, isLight }) {
  ...
  let textScale = model.manualWrap
    ? 0.62
    : getTextScale(model.centerText, model.kWidth, model.isFluentCenter);
